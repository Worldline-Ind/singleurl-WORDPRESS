...
class TransactionRequestBean
{
    ...
    public function getEncryptedData()
    {
        try {
            ...
            if($requestValidate->isBlankOrNull($this->hashalgo)){
                $hashalgo='SHA3-512';
               }else{
            ...
            $withsalt=$this->strReqst."|".$salt;
            $sha = hash($hashalgo, $withsalt);
            $this->strReqst .= "|hash=" . $sha. "|hashAlgo=".$hashalgo."|random_salt=".$salt;
